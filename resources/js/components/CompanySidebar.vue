<template>
   ...
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
         <li>
            <a :href="routes.dashboard":class="[
            isActive(routes.dashboard)
               ? 'text-blue-500 bg-gray-200 dark:bg-gray-600'
         ...
         <li>
            <a :href="routes.products" 
               :class="[ isActive(routes.products)
                  ? 'text-blue-500 bg-gray-200 dark:bg-gray-600'
                  : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700',
                     'flex items-center p-2 rounded-lg group'
               ]">
         ...
         <li>
            <a :href="routes.orders" :class="[ isActive(routes.orders)
                  ? 'text-blue-500 bg-gray-200 dark:bg-gray-600'
                  : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700',
                     'flex items-center p-2 rounded-lg group'
               ]">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Siparişler</span>
            </a>
         </li>
         <li>
            <a :href="routes.customers" :class="[ isActive(routes.customers)
                  ? 'text-blue-500 bg-gray-200 dark:bg-gray-600'
                  : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700',
                     'flex items-center p-2 rounded-lg group'
               ]">
