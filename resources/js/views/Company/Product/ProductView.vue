...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
      ...
      <div class="flex justify-center mt-6">
        <nav class="inline-flex space-x-1">
          <button 
            ...
            class="px-4 py-2 bg-gray-300 text-gray-800 rounded-l hover:bg-gray-400">
            Previous
          </button>
          <button 
            v-for="page in pages" 
            :key="page"
            @click="goToPage(page)"
            class="px-4 py-2 bg-white border border-gray-300 hover:bg-gray-100"
          ...
          <button 
            ...
            class="px-4 py-2 bg-gray-300 text-gray-800 rounded-r hover:bg-gray-400">
            Next
          </button>
        </nav>
      </div>
  ...
  router.push('/company/products/add');
  };
